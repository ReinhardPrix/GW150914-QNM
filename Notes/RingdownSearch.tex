...
\begin{center}
  \parbox{0.7\textwidth}{
    ...
    the IMR waveform starting at about $\tStart \gtrsim \tMerger + 3\,\ms$, or $\sim10\,M$
    after merger.
    %% Output from 'plotContours()' in 'onSource' search case:
    %% t0 = tM + 3.0ms: log10BSG = 14, SNR = 8.5
    The corresponding Bayes factor at this point is $\log_{10}B \sim 14$ and the MAP waveform SNR is $\sim 8$.
    %% t0 = tM + 5.0ms: log10BSG = 6.5, SNR = 6.3
    At $\tStart = \tMerger + 5\,\ms$ the MAP parameters fall within the contour predicted in GR for the least-damped QNM,
    with $\log_{10}B \sim 6.5$ and SNR\ $\sim 6.3$.
    %% t0 = tM + 6.5ms: log10BSG = 3.5, SNR = 4.8
    At $\tStart = \tMerger + 6.5\,\ms$, or about $\sim20\,M$ after merger,
    the Bayes factor is $\log_{10}B \sim 3.5$ with SNR\ $\sim 4.8$.
    The signal becomes undetectable after about $\tStart \gtrsim \tMerger + 9\,\ms$,
    where $B \lesssim 1$.
  }
...
left):\\
\newcommand{\onSourceDir}{./Results/Results-160426-15h31-onSource17-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0/}
\parbox{\textwidth}{
...
Fig.~\ref{fig:spectra}. Note that the 'data spectra' are showing the data from the $T=8\,$s ``on-source'' window.
\begin{figure}[htbp]
  \centering
...
show a zoom on the most relevant frequency range of ${[200,300]}\,\Hz$.
\begin{figure}[htbp]
  \centering
...
We search the $\{\freq,\tau\}$ range with uniform priors in $\freq\in{[200,300]}\,\Hz$ and $\tau\in{[0.5,20]}\,\ms$, in steps of $d\freq=1\,\Hz$ and
$d\tau=0.2\,\ms$, respectively.
...
\newpage
\parbox{\textwidth}{
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0003-GPS1126259462.424000s-snapshot}.pdf}\\
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0005-GPS1126259462.425000s-snapshot}.pdf}
}

\newpage
\parbox{\textwidth}{
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0007-GPS1126259462.426000s-snapshot}.pdf}\\
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0008-GPS1126259462.427000s-snapshot}.pdf}
}

\newpage
\parbox{\textwidth}{
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0009-GPS1126259462.428000s-snapshot}.pdf}\\
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0010-GPS1126259462.429000s-snapshot}.pdf}
}

\newpage
\parbox{\textwidth}{
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0011-GPS1126259462.429500s-snapshot}.pdf}\\
\includegraphics[width=0.9\textwidth]{{\onSourceDir/Search0012-GPS1126259462.430000s-snapshot}.pdf}
}
...
\newcommand{\offSourceGaussDir}{./Results/Results-160427-05h12-offSource10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectSqrtSX_8e-24_8e-24}
\newcommand{\offSourceDir}{./Results/Results-160427-08h50-offSource10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0}
...
\newcommand{\InjSignalOnlyPriorRangesDir}{./Results/Results-160426-15h35-injections10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectPriorRanges-injectSqrtSX_0_0-assumeSqrtSX_8e-24_8e-24}
\newcommand{\InjKnownGaussPriorRangesDir}{./Results/Results-160426-19h21-injections10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectPriorRanges-injectSqrtSX_8e-24_8e-24-assumeSqrtSX_8e-24_8e-24}
\newcommand{\InjUnknownGaussPriorRangesDir}{./Results/Results-160426-21h49-injections10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectPriorRanges-injectSqrtSX_8e-24_8e-24}
\newcommand{\InjOffSourcePriorRangesDir}{./Results/Results-160427-00h18-injections10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectPriorRanges}

\newpage
\subsubsection{Case 1(a): QNM parameter drawn from priors, signal-only with assumed white noise}
...
\newpage
\subsubsection{Case 1(b): QNM parameter drawn from priors, \textbf{known} Gaussian white noise}
...
\newpage
\subsubsection{Case 1(c): QNM parameter drawn from priors, \textbf{unknown} Gaussian white noise}
...
\newpage
\subsubsection{Case 1(d): QNM parameter drawn from priors, off-source detector data}
...
\newpage
\newcommand{\InjOffSourceGRDir}{./Results/Results-160427-09h52-injections10000-data20Hz-1900Hz-Prior-f200Hz-300Hz-df1.0Hz-tau0.5ms-20.0ms-dtau0.2ms-H2.0-10.0-dH1.0-injectGR}

\subsubsection{Case 2: fixed ``GR injections'' $\{A\in[3,8]\times10^{-22},\freq=251\Hz,\tau=4\ms\}$, off-source detector data}
\label{sec:case-4:GR-injections-real-noise}

\parbox{\textwidth}{
  \includegraphics[width=0.9\textwidth]{{\InjOffSourceGRDir/Injections-PE-errors}.pdf}\\
  \includegraphics[width=0.9\textwidth]{{\InjOffSourceGRDir/Injections-PE-coverage}.pdf}
}
